...
# Core module
from interfaces.api.v1.core import novels, chapters, scene_generation_routes, settings as llm_settings, export, chapter_fusion, state_locks, validation_reports
...
app.include_router(state_locks.router, prefix="/api/v1")
app.include_router(validation_reports.router, prefix="/api/v1")
