...
4. events: 事件列表，每项包含 type、description、involved_characters（数组）、chapter
5. foreshadowing_planted: 本章新埋下的伏笔列表，每项包含 description、chapter
6. foreshadowing_resolved: 本章回收/兑现的伏笔列表，每项包含 foreshadowing_id 或 description、chapter
...
请返回以下九个键，不要增加其他顶层字段：new_characters, character_actions, relationship_changes, events, foreshadowing_planted, foreshadowing_resolved, timeline_events, advanced_storylines, new_storylines"""
